const dict = {
  en: {
    ...
    maximizeChatAria: 'Maximize chat window',
    restoreChatAria: 'Restore chat window',
    ...
    micAriaStart: 'Ask by voice',
    micAriaStop: 'Stop recording',
    listeningLabel: 'Listening…',
    transcribingLabel: 'Transcribing…',
    micPermissionError: "Couldn't access your microphone. Please check your browser's permissions.",
  ...
  hi: {
    ...
    maximizeChatAria: 'चैट विंडो बड़ी करें',
    restoreChatAria: 'चैट विंडो सामान्य करें',
    ...
    micAriaStart: 'आवाज़ से पूछें',
    micAriaStop: 'रिकॉर्डिंग रोकें',
    listeningLabel: 'सुन रहा है…',
    transcribingLabel: 'लिख रहा है…',
    micPermissionError: 'माइक्रोफ़ोन तक पहुंच नहीं हो सकी। कृपया अपनी ब्राउज़र अनुमतियां जांचें।',
