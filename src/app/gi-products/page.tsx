...
interface GIProduct {
  ...
  district: string
  womenPercent: number
  image?: string  // filename in /public/gi/ e.g. "madhubani.jpg"
}
...
const GI_PRODUCTS: GIProduct[] = [
  // Bihar
  {
    ...
    category: 'handicraft', accent: '#8B1A1A', emoji: '🎨', womenPercent: 95, image: 'madhubani.jpg',
  ...
  },
  {
    ...
    category: 'textile', accent: '#8B6914', emoji: '🧵', womenPercent: 60, image: 'bhagalpur-silk.jpg',
  ...
  },
  {
    ...
    category: 'textile', accent: '#C94B1A', emoji: '🪡', womenPercent: 100, image: 'sujini.jpg',
  ...
  // Jammu & Kashmir
  {
    ...
    category: 'textile', accent: '#4A3728', emoji: '🧣', womenPercent: 100, image: 'pashmina.jpg',
  ...
  },
  {
    ...
    category: 'textile', accent: '#1B2E4A', emoji: '🌸', womenPercent: 80, image: 'kani-shawl.jpg',
  ...
  // West Bengal
  {
    ...
    category: 'agricultural', accent: '#3B5A2F', emoji: '🍵', womenPercent: 70, image: 'darjeeling-tea.jpg',
  ...
  },
  {
    ...
    category: 'textile', accent: '#7A3B52', emoji: '🧶', womenPercent: 65, image: 'baluchari.jpg',
  ...
  // Uttar Pradesh
  {
    ...
    category: 'textile', accent: '#B8860B', emoji: '✨', womenPercent: 60, image: 'banarasi-silk.jpg',
  ...
  },
  {
    ...
    category: 'textile', accent: '#C94B1A', emoji: '🌼', womenPercent: 100, image: 'chikankari.jpg',
  ...
  // Rajasthan
  {
    ...
    category: 'handicraft', accent: '#C94B1A', emoji: '🖼️', womenPercent: 70, image: 'sanganer.jpg',
  ...
  },
  {
    ...
    category: 'textile', accent: '#B8860B', emoji: '💛', womenPercent: 85, image: 'kota-doria.jpg',
  ...
  // Tamil Nadu
  {
    ...
    category: 'textile', accent: '#7A3B52', emoji: '🏛️', womenPercent: 65, image: 'kanchipuram.jpg',
  ...
  },
  {
    ...
    category: 'handicraft', accent: '#B8860B', emoji: '🌟', womenPercent: 60, image: 'thanjavur.jpg',
  ...
  // Assam
  {
    ...
    category: 'textile', accent: '#8B6914', emoji: '✨', womenPercent: 100, image: 'muga-silk.jpg',
  ...
  // Punjab
  {
    ...
    category: 'textile', accent: '#C94B1A', emoji: '🌸', womenPercent: 100, image: 'phulkari.jpg',
  ...
  // Karnataka
  {
    ...
    category: 'textile', accent: '#7A3B52', emoji: '👑', womenPercent: 70, image: 'mysore-silk.jpg',
  ...
  },
  {
    ...
    category: 'handicraft', accent: '#3B5A2F', emoji: '🎭', womenPercent: 55, image: 'channapatna.jpg',
  ...
  // Madhya Pradesh
  {
    ...
    category: 'textile', accent: '#1B2E4A', emoji: '🌙', womenPercent: 80, image: 'chanderi.jpg',
  ...
  },
  {
    ...
    category: 'textile', accent: '#C94B1A', emoji: '👸', womenPercent: 100, image: 'maheshwari.jpg',
  ...
  // Odisha
  {
    ...
    category: 'textile', accent: '#8B1A1A', emoji: '🌀', womenPercent: 80, image: 'sambalpuri.jpg',
  ...
  },
  {
    ...
    category: 'handicraft', accent: '#B8860B', emoji: '🎨', womenPercent: 70, image: 'pattachitra.jpg',
  ...
  // Himachal Pradesh
  {
    ...
    category: 'textile', accent: '#8B1A1A', emoji: '❄️', womenPercent: 90, image: 'kullu-shawl.jpg',
  ...
  // Gujarat
  {
    ...
    category: 'handicraft', accent: '#C94B1A', emoji: '🪞', womenPercent: 100, image: 'kutch.jpg',
  ...
  // Maharashtra
  {
    ...
    category: 'textile', accent: '#1B2E4A', emoji: '🦚', womenPercent: 65, image: 'paithani.jpg',
  ...
  // Telangana
  {
    ...
    category: 'textile', accent: '#3B5A2F', emoji: '🔮', womenPercent: 75, image: 'pochampally.jpg',
  ...
  // Andhra Pradesh
  {
    ...
    category: 'handicraft', accent: '#C94B1A', emoji: '🎪', womenPercent: 60, image: 'kondapalli.jpg',
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <div style={{ fontFamily: "'Lato', sans-serif", fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: '#fff', opacity: 0.8, marginBottom: 4 }}>
              {product.state} · {product.year}
            </div>
            <h2 style={{ fontFamily: "'EB Garamond', serif", fontSize: 'clamp(1.4rem, 3vw, 2rem)', fontWeight: 700, color: '#fff', margin: 0, textShadow: '0 1px 4px rgba(0,0,0,0.4)' }}>
              {product.name}
            </h2>
            <div style={{ fontFamily: "'Lato', sans-serif", fontSize: '0.72rem', color: 'rgba(255,255,255,0.7)', marginTop: 4 }}>
              {product.giTag}
            </div>
          </div>
          <button
